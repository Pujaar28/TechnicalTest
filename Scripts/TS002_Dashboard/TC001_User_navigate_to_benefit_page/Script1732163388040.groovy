...
WebUI.click(findTestObject('dashboard_Page/benefit_Page'))

WebUI.verifyElementPresent(findTestObject('benefit_Page/benefit_Text'), 0)

String expectedUrl = 'https://smpd.wibidigital.com/admin/master-data/benefit'
