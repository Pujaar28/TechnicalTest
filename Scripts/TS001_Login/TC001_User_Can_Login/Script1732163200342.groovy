...
WebUI.verifyElementPresent(findTestObject('Object Repository/dashboard_Page/app_Logo'), 0)

boolean isLoginSuccessful = WebUI.verifyElementPresent(findTestObject('Object Repository/dashboard_Page/masterdata_text'), 10)

if (isLoginSuccessful) {
	WebUI.comment('Login was successful.')
} else {
